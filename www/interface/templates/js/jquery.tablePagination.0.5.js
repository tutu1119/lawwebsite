 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="interface/icon/first.gif",  
			prevArrow : (new Image()).src= "interface/icon/prev.gif",
			lastArrow : (new Image()).src="interface/icon/last.gif",
			nextArrow : (new Image()).src="interface/icon/next.gif",
			rowsPerPage : 5,
			currPage : 1,
      ...
      function hideOtherPages(pageNum) {
		...
		if(pageNum==1)
		{
			...
			var endIndex = (startIndex + defaults.rowsPerPage);
		}
		else
		{
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<select id='tablePagination_rowsPerPage' style='width: 100px;'><option value='5'>5</option></select>");
        htmlBuffer.push(" item per page");
        ...
        htmlBuffer.push("<input id='tablePagination_currPage' type='input' value='"+currPageNumber+"' size='1' style='width: 20px;'>");
